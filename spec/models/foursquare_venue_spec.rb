...
RSpec.describe FoursquareVenue do
  ...
  describe '#venue' do
    ...
    #   stub_request(:get, "https://api.foursquare.com/v2/venues/search?client_id=#{FOURSQUARE_ID}&client_secret=#{FOURSQUARE_SECRET}&ll=28.37777,-81.56498&query=disney&v=20160607").
    #     with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
